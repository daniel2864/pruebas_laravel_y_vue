    ...
    <div class="row g-0">
      ...
      <div class="col-6">
        ...
        >
          <span class="svg-icon svg-icon-3x svg-icon-success mb-2">
            <inline-svg
              :src="getAssetPath('media/icons/duotune/finance/fin009.svg')"
            />
          </span>
      ...
      <div class="col-6">
        ...
        >
          <span class="svg-icon svg-icon-3x svg-icon-success mb-2">
            <inline-svg
              :src="getAssetPath('media/icons/duotune/abstract/abs042.svg')"
            />
          </span>
      ...
      <div class="col-6">
        ...
        >
          <span class="svg-icon svg-icon-3x svg-icon-success mb-2">
            <inline-svg
              :src="getAssetPath('media/icons/duotune/finance/fin006.svg')"
            />
          </span>
