      ...
      <div class="card-toolbar">
        ...
        >
          <span class="svg-icon svg-icon-3">
            <inline-svg
              :src="getAssetPath('media/icons/duotune/general/gen035.svg')"
            />
          </span>
          Add new method</a
        >
        ...
        <div class="py-3 d-flex flex-stack flex-wrap">
          ...
          <div class="d-flex my-3 ms-9">
            ...
            >
              ...
              <span class="svg-icon svg-icon-3">
                <inline-svg
                  :src="getAssetPath('media/icons/duotune/general/gen027.svg')"
                />
              </span>
            </a>
            <!--end::Delete-->
            ...
            >
              <span class="svg-icon svg-icon-3">
                <inline-svg
                  :src="getAssetPath('media/icons/duotune/general/gen019.svg')"
                />
              </span>
            </a>
            <!--begin::Menu-->
