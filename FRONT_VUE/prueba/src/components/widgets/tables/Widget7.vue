  ...
  setup() {
    const items = [
      [
        {
          icon: {
            file: getAssetPath("media/icons/duotune/coding/cod002.svg"),
            color: "success",
          },
          info: {
            title: "Media Device",
        ...
        {
          icon: {
            file: getAssetPath("media/icons/duotune/general/gen024.svg"),
            color: "danger",
          },
          info: {
            title: "Special Meal",
        ...
        {
          icon: {
            file: getAssetPath("media/icons/duotune/maps/map004.svg"),
            color: "primary",
          },
          info: {
            title: "New Users",
        ...
        {
          icon: {
            file: getAssetPath("media/icons/duotune/abstract/abs027.svg"),
            color: "warning",
          },
          info: {
        ...
        {
          icon: {
            file: getAssetPath("media/icons/duotune/art/art007.svg"),
            color: "info",
          },
          info: {
      ...
      [
        {
          icon: {
            file: getAssetPath("media/icons/duotune/abstract/abs042.svg"),
            color: "info",
          },
          info: {
            title: "Strawberry Boxes",
      ...
      [
        {
          icon: {
            file: getAssetPath("media/icons/duotune/ecommerce/ecm002.svg"),
            color: "success",
          },
          info: {
            title: "Media Device",
