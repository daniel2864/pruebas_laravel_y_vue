...
export default defineComponent({
  ...
  setup() {
    const items = [
      {
        icon: getAssetPath("media/icons/duotune/maps/map004.svg"),
        title: "Sales",
      ...
      {
        icon: getAssetPath("media/icons/duotune/general/gen024.svg"),
        title: "Revenue",
      ...
      {
        icon: getAssetPath("media/icons/duotune/electronics/elc005.svg"),
        title: "Growth",
        description: "80% Rate",
        stats: "$8,8m",
        arrow: "up",
      ...
      {
        icon: getAssetPath("media/icons/duotune/general/gen005.svg"),
        title: "Dispute",
