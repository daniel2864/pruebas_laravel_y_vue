            ...
            <span class="symbol symbol-50px me-6">
              <span class="symbol-label">
                <span class="svg-icon svg-icon-1 svg-icon-gray-600">
                  <inline-svg
                    :src="
                      getAssetPath('media/icons/duotune/finance/fin001.svg')
                    "
                  />
                </span>
              </span>
            ...
            <span class="symbol symbol-50px me-6">
              <span class="symbol-label">
                <span class="svg-icon svg-icon-1 svg-icon-gray-600">
                  <inline-svg
                    :src="
                      getAssetPath('media/icons/duotune/graphs/gra006.svg')
                    "
                  />
                </span>
              </span>
            ...
            <span class="symbol symbol-50px me-6">
              <span class="symbol-label">
                <span class="svg-icon svg-icon-1 svg-icon-gray-600">
                  <inline-svg
                    :src="
                      getAssetPath('media/icons/duotune/graphs/gra008.svg')
                    "
                  />
                </span>
              </span>
